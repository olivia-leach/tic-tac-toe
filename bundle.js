...
/***/ function(module, exports, __webpack_require__) {
	...
	var index = function index(success, failure) {
	...
	var create = function create(success, failure) {
	...
	var update = function update(success, failure, data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexGameSuccess = function indexGameSuccess(data) {
	  ...
	  var gamesPlayed = app.gameHistory.games.length;

	  $("#gamesPlayed").text(app.gameHistory.games.length);
	  $("#game-history-table").show();
	  var winCount = 0;
	  for (var i = 0; i < app.gameHistory.games.length; i++) {
	    ...
	    var board = app.gameHistory.games[i].cells;
	    ...
	    $("#game-history-table").find('tbody').append($('<tr class=' + winnerClass + '>').append($('<td>').text(i + 1)).append($('<td>').text(playedAs)).append($('<td>').text(over)).append($('<td>').text(app.gameHistory.games[i].winner)));
	  }

	  $("#gamesWon").text(winCount);

	  var percent = Math.round(100 * (winCount / app.gameHistory.games.length), 0) + "%";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameSetUp = function gameSetUp(board) {
	  $('.square > img').remove();
	  $("#gameOver").fadeOut();
	  $("#xWins").fadeOut();
	  $("#oWins").fadeOut();
	...
	var turn = function turn(board, marker, square) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(22);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
